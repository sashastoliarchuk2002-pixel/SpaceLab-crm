...
const supabase = createClient(SUPABASE_URL || "", SUPABASE_ANON_KEY || "", {
  global: {
    // some mobile browsers (Safari in particular) cache GET requests aggressively —
    // this forces every read to actually hit Supabase instead of a stale cached copy
